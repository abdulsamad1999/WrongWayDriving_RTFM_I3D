...
parser.add_argument('--gt', default='list/gt-wrongway.npy', help='file of ground truth ')
...
parser.add_argument('--rgb-list', default='list/mytrain.list', help='list of training feature paths')
parser.add_argument('--test-rgb-list', default='list/mytest.list', help='list of test feature paths')
parser.add_argument('--feature-size', type=int, default=1024, help='feature dimension for input features')
parser.add_argument('--num-segments', type=int, default=32, help='number of temporal segments (frames per video)')
